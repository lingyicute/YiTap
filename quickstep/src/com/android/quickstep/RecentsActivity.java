...
public final class RecentsActivity extends StatefulActivity<RecentsState> {
    ...
    public ActivityOptionsWrapper getActivityLaunchOptions(final View v, @Nullable ItemInfo item) {
        ...
        final ActivityOptions options = YitapQuickstepCompat.getActivityOptionsCompat().makeRemoteAnimation(
                new RemoteAnimationAdapter(wrapper, RECENTS_LAUNCH_DURATION,
                        RECENTS_LAUNCH_DURATION - STATUS_BAR_TRANSITION_DURATION
                                - STATUS_BAR_TRANSITION_PRE_DELAY),
                YitapQuickstepCompat.getRemoteTransitionCompat().getRemoteTransition(wrapper.toRemoteTransition(), getIApplicationThread(),
                        "LaunchFromRecents"),
                "Yitap");
    ...
    private void startHomeInternal() {
        ...
        ActivityOptions options = YitapQuickstepCompat.getActivityOptionsCompat().makeRemoteAnimation(
                ...
                YitapQuickstepCompat.getRemoteTransitionCompat().getRemoteTransition(runner.toRemoteTransition(), getIApplicationThread(),
